...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('page_number', models.IntegerField(db_index=True, verbose_name='number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('word_seq', models.CharField(default='', max_length=150, verbose_name='word')),
                ('position', models.IntegerField(default=0, verbose_name='position')),
                ('line_number', models.IntegerField(default=0, verbose_name='line no')),
                ('edition', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tipitaka.edition', verbose_name='edition')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('edition', models.ManyToManyField(to='tipitaka.edition')),
            ],
        ),
        migrations.CreateModel(
            name='Structure',
